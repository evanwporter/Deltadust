...
namespace Deltadust.Entities.Animated {
    ...
    public class NPC : AnimatedEntity, IInteractableEntity {
        ...
        public override void LoadContent() {
            SpriteSheet spriteSheet = ResourceManager.LoadSprite(_name);
        }
        ...
        private void StartDialogue() {
            Console.WriteLine($"NPC says: Ooga booga");
        }
